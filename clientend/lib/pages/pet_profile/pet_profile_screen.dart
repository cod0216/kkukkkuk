              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildOcrResultItem(
                      '진단명',
                      processedData['diagnosis'] ?? '없음',
                    ),
                    _buildOcrResultItem(
                      '병원명',
                      processedData['hospitalName'] ?? '없음',
                    ),
                    _buildOcrResultItem(
                      '수의사명',
                      processedData['doctorName'] ?? '없음',
                    ),
                    _buildOcrResultItem(
                      '메모/증상',
                      processedData['notes'] ?? '없음',
                    ),
                    // 검사, 처방, 접종 목록 표시
            ...
            child: Column(
              ...
              children:
                  items.map((item) {
                    ...
                    return Text(
                      '• ${itemText.isNotEmpty ? itemText : '내용 없음'}',
                    );
                  }).toList(),
            ),
          ),
