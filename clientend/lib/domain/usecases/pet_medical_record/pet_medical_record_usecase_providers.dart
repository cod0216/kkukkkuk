...
import 'package:kkuk_kkuk/data/repositories/pet_medical_record_repository.dart';
...
final getMedicalRecordsUseCaseProvider = Provider<GetMedicalRecordsUseCase>((ref) {
  final repository = ref.watch(petMedicalRecordRepositoryProvider);
  return GetMedicalRecordsUseCase(repository);
});

final addMedicalRecordUseCaseProvider = Provider<AddMedicalRecordUseCase>((ref) {
  final repository = ref.watch(petMedicalRecordRepositoryProvider);
  return AddMedicalRecordUseCase(repository);
});

final getMedicalRecordsByDateRangeUseCaseProvider = Provider<GetMedicalRecordsByDateRangeUseCase>((ref) {
  final repository = ref.watch(petMedicalRecordRepositoryProvider);
  return GetMedicalRecordsByDateRangeUseCase(repository);
});

final verifyMedicalRecordUseCaseProvider = Provider<VerifyMedicalRecordUseCase>((ref) {
  final repository = ref.watch(petMedicalRecordRepositoryProvider);
  return VerifyMedicalRecordUseCase(repository);
});

final checkAccessPermissionUseCaseProvider = Provider<CheckAccessPermissionUseCase>((ref) {
  final repository = ref.watch(petMedicalRecordRepositoryProvider);
  return CheckAccessPermissionUseCase(repository);
});

final grantAccessPermissionUseCaseProvider = Provider<GrantAccessPermissionUseCase>((ref) {
  final repository = ref.watch(petMedicalRecordRepositoryProvider);
