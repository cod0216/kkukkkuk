...
const DoctorRegistration: React.FC<DoctorRegistrationProps> = ({ doctors, setDoctors }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mt-6">
        <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">등록된 의사 목록</h4>
        {doctors.length === 0 ? (
