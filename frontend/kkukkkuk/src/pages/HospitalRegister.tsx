...
import { registerStart, registerSuccess, registerFailure, selectLoading, selectError } from '../redux/slices/authSlice';
...
const HospitalRegister: React.FC = () => {
  ...
  const searchHospitalInfo = async () => {
    ...
    try {
      ...
      if (result.status === 'SUCCESS' && result.data) {
        const { id, name, address, phone_number } = result.data as HospitalAuthorizationResponse;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { hospitalName, address, phoneNumber, licenseNumber, username, password, confirmPassword, email, hospitalId } = formData;
