 ...
 * 25.04.08          eunchang           사용하지 않는 ERROR 제거
 */
@Getter
@AllArgsConstructor
public enum ErrorCode {
    ...
    SELF_CHAT_NOT_ALLOWED(HttpStatus.CONFLICT, "CHAT-001", "본인과는 대화할 수 없습니다."),
    NO_CHATROOM(HttpStatus.NOT_FOUND, "CHAT-002", "채팅방을 찾을 수 없습니다."),
